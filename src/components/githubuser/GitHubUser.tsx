...
const GitHubUser: React.FC = () => {
    ...
    return (
        <div className="container mx-auto p-4 text-center items-center">
            ...
            {invalidUser && <p className="text-red-500">Invalid user. Please try again with a valid username.</p>}
            {userData && (
                <div className="flex flex-wrap-reverse flex-col justify-between gap-6 w-full h-auto p-8 mt-9 rounded-lg items-center text-center">
                    <div className="w-full lg:w-1/3 p-3 flex flex-col text-center">
                        <h1 className="text-3xl font-bold">USER DETAILS</h1>
                    ...
                    <div className="w-full lg:w-2/3 p-3 flex flex-col items-center text-center">
                        <h1 className="text-3xl font-bold">PROJECTS</h1>
                        <ul className="w-full overflow-y-scroll max-h-[50vh]">
                            {repoData.map((repo) => (
                                <li key={repo.id} className="mt-3 p-2 rounded-md border border-gray-300">
